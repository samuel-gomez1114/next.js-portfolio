const Meta = () => {
  return (
    <>
      ...
      <title> Nazarii Honcharenko : Portfolio </title>
      ...
      <meta property="og:site_name" content="Nazarii Honcharenko" />
      <meta property="og:title" content='Nazarii Honcharenko | Portfolio' />
